...
function Detail() {
  ...
  return (
    <div className=' p-4 mt-4 flex flex-col md:flex-row w-full '>
        { loading ? <div className="flex w-full justify-center items-center h-96"><ProgressBar height={80} width={80} color="white" /></div> :
        <>
        <img 
